...
@WebServlet(name = "StudentJobResignationServlet", urlPatterns = {"/api/student/jobs/resign"})
public class StudentJobResignationServlet extends StudentBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            StudentResignationRequest request = readJson(req, StudentResignationRequest.class);
            writeSuccess(resp, studentService.resignFromAssignedJob(getServletContext(), studentUserId, request));
