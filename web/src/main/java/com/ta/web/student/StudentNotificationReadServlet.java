...
@WebServlet(name = "StudentNotificationReadServlet", urlPatterns = {"/api/student/notifications/read/*"})
public class StudentNotificationReadServlet extends StudentBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            notificationService.markRead(getServletContext(), studentUserId, notificationId);
