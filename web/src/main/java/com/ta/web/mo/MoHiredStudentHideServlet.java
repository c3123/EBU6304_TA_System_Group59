...
import com.ta.dto.mo.MoHiredStudentHideRequest;
...
@WebServlet(name = "MoHiredStudentHideServlet", urlPatterns = {"/api/mo/hired-students/hide"})
public class MoHiredStudentHideServlet extends MoBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            MoHiredStudentHideRequest request = readJson(req, MoHiredStudentHideRequest.class);
            ...
            writeSuccess(resp, moApplicationService.hideFormerHiredStudent(getServletContext(), moId, request.getApplicationId()));
