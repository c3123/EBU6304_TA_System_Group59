...
@WebServlet(name = "MoNotificationsServlet", urlPatterns = {"/api/mo/notifications"})
public class MoNotificationsServlet extends MoBaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Object data = moNotificationService.list(getServletContext(), moId);
