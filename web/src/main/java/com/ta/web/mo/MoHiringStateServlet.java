...
@WebServlet(name = "MoHiringStateServlet", urlPatterns = {"/api/mo/hiring/state"})
public class MoHiringStateServlet extends MoBaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Object data = moHiringService.getState(getServletContext(), moId);
