...
@WebServlet(name = "MoJobEditServlet", urlPatterns = {"/api/mo/jobs/edit/*"})
public class MoJobEditServlet extends MoBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            MoJobEditRequest request = readJson(req, MoJobEditRequest.class);
            Object data = moJobService.editJob(getServletContext(), moId, jobId, request);
