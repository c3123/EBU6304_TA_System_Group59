...
@WebServlet(name = "MoJobDeleteServlet", urlPatterns = {"/api/mo/jobs/delete/*"})
public class MoJobDeleteServlet extends MoBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            moJobService.deleteDraftJob(getServletContext(), moId, jobId);
            writeSuccess(resp, Map.of("jobId", jobId, "deleted", true));
