...
import com.ta.dto.mo.MoApplicationStatusUpdateRequest;
...
/**
 * POST /api/mo/applications/status — update application to shortlisted | hired | rejected.
 */
@WebServlet(name = "MoApplicationStatusServlet", urlPatterns = {"/api/mo/applications/status"})
public class MoApplicationStatusServlet extends MoBaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            MoApplicationStatusUpdateRequest body = readJson(req, MoApplicationStatusUpdateRequest.class);
            ...
            Object data = moApplicationService.updateApplicationStatus(
                    getServletContext(),
                    moId,
