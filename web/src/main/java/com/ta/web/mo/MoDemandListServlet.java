...
/**
 * Route contract: GET /api/mo/demands
 * Responsibility: list current MO demands and approval progress.
 */
@WebServlet(name = "MoDemandListServlet", urlPatterns = {"/api/mo/demands/list"})
public class MoDemandListServlet extends MoBaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            MoDemandListResponse data = moDemandService.listMyDemands(getServletContext(), moId);
